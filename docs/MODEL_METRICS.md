...
Первичный поиск охватывал все горизонты из задания: один, три, пять, десять и двадцать дат действия курса. В раннем сопоставимом опыте с классическими моделями лучший lift составлял для них 1,110; 1,055; 1,066; 1,089 и 1,107. Минимальный годовой результат ни у одного варианта не превышал 1,084.

Следующая серия использовала десятилетнее обучающее окно и единый последовательный протокол на 2023–2025 годах. Lift составил 1,300 для H1, 1,300 для H3, 1,371 для H5, 1,336 для H10 и 1,342 для H20. Преимущество момента для H10 равнялось 38,3 базисного пункта, а для H20 — 43,3. Эти горизонты давали полезный сигнал, однако не создавали более убедительного сочетания качества, своевременности и продуктовой роли. Для H20 упущенная выгода достигала 239,2 базисного пункта, поскольку за длинное окно чаще появлялся существенно лучший день.

После расширения данных и настройки частоты H3 и H5 образовали два различимых режима. H3 даёт 1,12 сигнала в неделю при lift 1,504 и подходит для регулярного наблюдения за коротким сроком решения. H5 снижает частоту до 0,66 сигнала в неделю, повышая lift до 1,986 и преимущество момента до 95,6 базисного пункта. Одного дня недостаточно для доставки сообщения и действия клиента, тогда как десять и двадцать дней слабее соответствуют формулировке «выгодно сейчас». Поэтому H3 выбран как основной горизонт, а H5 — как более редкая альтернатива для клиента с большей гибкостью срока.
