...
Главный документ — [HACKATHON_ML_PLAN_V2.md](HACKATHON_ML_PLAN_V2.md). Он учитывает последнюю Q&A, эксперименты `edelkin_test`, найденные дефекты evaluator и уже готовые компоненты V0. [Первоначальный план](HACKATHON_ML_PLAN.md) оставлен как архив.
