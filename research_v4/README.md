**Актуальный финальный отбор:** [TabM на десятилетней истории, два сценария и исполняемый профиль](final_sprint/REPORT.md). Уточнение: дополнительная задержка банковских данных исключена из критериев отбора.
