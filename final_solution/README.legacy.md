**Новый выбранный профиль KZT:** [final_sprint — TabM, NOW и CLOSING](final_sprint/README.md). Запуск: `python final_solution/final_sprint/predict.py` из корня AlphaTransfer. Полный отчёт и сравнение с V3 находятся в `research_v4/final_sprint/REPORT.md`.
